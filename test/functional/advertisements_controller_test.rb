...
class AdvertisementsControllerTest < ActionController::TestCase
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post :create, advertisement: { ad_target_url: @advertisement.ad_target_url, alt_text: @advertisement.alt_text, title: @advertisement.title }
    end
  ...
  test "should update advertisement" do
    put :update, id: @advertisement, advertisement: { ad_target_url: @advertisement.ad_target_url, alt_text: @advertisement.alt_text, title: @advertisement.title }
    assert_redirected_to advertisement_path(assigns(:advertisement))
  end
